...
use constant MONITORING_NOT_ACTIVE		                => 4;
use constant AUTHENTICATION_FAILED	                    => 5;
use constant MULTIPLE_RESULTS				            => 6;
use constant MONITORING_NOT_NEEDED			            => 7;
use constant NO_MONITORING_USER                         => 8;
use constant UNEXPECTED_LDAP_VALUE			            => 9;
use constant WRONG_LDAP_SUBTREE 						=> 10;
use constant ALREADY_EXIST_ON_ZABBIX	                => 11;
use constant ALREADY_DELETED_ON_ZABBIX                  => 12;
